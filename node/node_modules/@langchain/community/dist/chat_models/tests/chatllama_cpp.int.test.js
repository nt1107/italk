...
test.skip("Test multiple messages", async () => {
    ...
    const response = await llamaCpp.invoke([
        ...
        new AIMessage("Hello Nigel! It is great to meet you, how can I help you today?"),
...
test.skip("Test system message", async () => {
    const llamaCpp = new ChatLlamaCpp({ modelPath: llamaPath });
    const response = await llamaCpp.invoke([
        new SystemMessage("You are a pirate, responses must be very verbose and in pirate dialect, add 'Arr, m'hearty!' to each sentence."),
...
test.skip("test streaming call", async () => {
    ...
    const stream = await llamaCpp.stream("Tell me a short story about a happy Llama.");
    const chunks = [];
