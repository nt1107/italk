...
test.skip("test call", async () => {
    ...
    const result = await ollama.invoke("What is a good name for a company that makes colorful socks?");
    console.log({ result });
});
...
test.skip("Test multiple messages", async () => {
    ...
    const res2 = await model.invoke([
        ...
        new AIMessage("Hello Jonas! It's nice to meet you. Is there anything I can help you with?"),
...
test.skip("test max tokens (numPredict)", async () => {
    ...
    const stream = await ollama.stream("explain quantum physics to me in as many words as possible");
    let numTokens = 0;
    let response = "";
