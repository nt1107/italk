...
exports.VercelKVSaver = void 0;
const kv_1 = require("@vercel/kv");
const web_1 = require("@langchain/langgraph/web");
class VercelKVSaver extends web_1.BaseCheckpointSaver {
    constructor(config, serde) {
        ...
        this.kv = (0, kv_1.createClient)(config);
    }
...
exports.VercelKVSaver = VercelKVSaver;
