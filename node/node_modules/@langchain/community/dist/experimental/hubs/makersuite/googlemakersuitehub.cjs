...
const googlepalm_js_1 = require("../../../chat_models/googlepalm.cjs");
const googlepalm_js_2 = require("../../../llms/googlepalm.cjs");
...
class MakerSuitePrompt {
    ...
    toModel() {
        ...
        if (this.promptType === "chat") {
            ...
            return new googlepalm_js_1.ChatGooglePaLM({
                examples,
                ...modelSettings,
            });
        }
        else {
            return new googlepalm_js_2.GooglePaLM(modelSettings);
        }
    }
    /**
