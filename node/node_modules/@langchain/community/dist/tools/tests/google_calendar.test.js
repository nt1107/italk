...
import { GoogleCalendarCreateTool, GoogleCalendarViewTool, } from "../google_calendar/index.js";
...
describe("GoogleCalendarCreateTool", () => {
    ...
    it("should throw an error if missing credentials", async () => {
        ...
        expect(() => new GoogleCalendarCreateTool(params)).toThrow("Missing GOOGLE_CALENDAR_CLIENT_EMAIL to interact with Google Calendar");
    });
    it("should throw an error if missing model", async () => {
        ...
        expect(() => new GoogleCalendarCreateTool(params)).toThrow("Missing llm instance to interact with Google Calendar");
    });
});
describe("GoogleCalendarViewTool", () => {
    ...
    it("should throw an error if missing credentials", async () => {
        ...
        expect(() => new GoogleCalendarViewTool(params)).toThrow("Missing GOOGLE_CALENDAR_CLIENT_EMAIL to interact with Google Calendar");
    });
    it("should throw an error if missing model", async () => {
        const params = {
            credentials: {
        ...
        expect(() => new GoogleCalendarViewTool(params)).toThrow("Missing llm instance to interact with Google Calendar");
    });
});
