...
exports.UnknownHandling = exports.UnstructuredDirectoryLoader = exports.UnstructuredLoader = exports.UNSTRUCTURED_API_FILETYPES = void 0;
const documents_1 = require("@langchain/core/documents");
const env_1 = require("@langchain/core/utils/env");
const directory_1 = require("langchain/document_loaders/fs/directory");
Object.defineProperty(exports, "UnknownHandling", { enumerable: true, get: function () { return directory_1.UnknownHandling; } });
const base_1 = require("@langchain/core/document_loaders/base");
exports.UNSTRUCTURED_API_FILETYPES = [
    ".txt",
    ".text",
    ".pdf",
    ".docx",
...
class UnstructuredLoader extends base_1.BaseDocumentLoader {
    constructor(filepathOrBufferOptions, unstructuredOptions = {}) {
        ...
        if (!isLegacySyntax) {
            ...
            this.apiKey =
                options.apiKey ?? (0, env_1.getEnvironmentVariable)("UNSTRUCTURED_API_KEY");
            this.apiUrl =
                options.apiUrl ??
                    (0, env_1.getEnvironmentVariable)("UNSTRUCTURED_API_URL") ??
                    this.apiUrl;
