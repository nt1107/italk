...
import { AstraDBVectorStore } from "../astradb.js";
describe.skip("AstraDBVectorStore", () => {
    ...
    test("addDocuments", async () => {
        ...
        await store.addDocuments(pageContent.map((content, idx) => new Document({ pageContent: content, metadata: metadata[idx] })));
    ...
    test("fromText", async () => {
        ...
        ], [{ id: 123 }, { id: 456 }, { id: 789 }], new OpenAIEmbeddings(), astraConfig);
    ...
    test("fromExistingIndex", async () => {
        ...
        const store2 = await AstraDBVectorStore.fromExistingIndex(new OpenAIEmbeddings(), astraConfig);
