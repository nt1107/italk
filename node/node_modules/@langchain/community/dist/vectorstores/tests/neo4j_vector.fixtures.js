...
const texts = metadatas.map((metadata) => `id ${metadata.id} `);
export const DOCUMENTS = texts.map((text, index) => new Document({ pageContent: text, metadata: metadatas[index] }));
export const TYPE_1_FILTERING_TEST_CASES = [
...
export const TYPE_2_FILTERING_TEST_CASES = [
    { filter: { id: 1 }, expected: [1] },
...
export const TYPE_3_FILTERING_TEST_CASES = [
