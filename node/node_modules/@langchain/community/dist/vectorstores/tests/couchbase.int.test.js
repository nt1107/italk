...
import { CouchbaseVectorStore, } from "../couchbase.js";
describe.skip("Couchbase vector store", () => {
    ...
    test("from Texts to vector store", async () => {
        ...
        const store = await CouchbaseVectorStore.fromTexts(texts, metadata, embeddings, couchbaseConfig);
    ...
    test("Add and delete Documents to vector store", async () => {
        ...
        const store = await CouchbaseVectorStore.initialize(embeddings, couchbaseConfig);
    ...
    test("hybrid search", async () => {
        ...
        const store = await CouchbaseVectorStore.fromTexts(texts, hybridSearchMetadata, embeddings, couchbaseConfig);
