...
test.skip("ClickHouseStore.fromText", async () => {
    const vectorStore = await ClickHouseStore.fromTexts(["Hello world", "Bye bye", "hello nice world"], [
        { id: 2, name: "2" },
        { id: 1, name: "1" },
        { id: 3, name: "3" },
...
test.skip("ClickHouseStore.fromExistingIndex", async () => {
    await ClickHouseStore.fromTexts(["Hello world", "Bye bye", "hello nice world"], [
        { id: 2, name: "2" },
        { id: 1, name: "1" },
        { id: 3, name: "3" },
    ], new HuggingFaceInferenceEmbeddings(), {
    ...
    const vectorStore = await ClickHouseStore.fromExistingIndex(new HuggingFaceInferenceEmbeddings(), {
        host: process.env.CLICKHOUSE_HOST || "localhost",
        port: process.env.CLICKHOUSE_PORT || "8443",
        username: process.env.CLICKHOUSE_USERNAME || "username",
        password: process.env.CLICKHOUSE_PASSWORD || "password",
