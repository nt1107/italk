...
import { MatchingEngine, IdDocument, } from "../googlevertexai.js";
describe("Vertex AI matching", () => {
    ...
    test.skip("delete", async () => {
        ...
        const oldResults = await engine.similaritySearch("this", 10);
        ...
        const newResults = await engine.similaritySearch("this", 10);
