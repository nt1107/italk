...
describe("XataChatMessageHistory", () => {
    ...
    test.skip("Test Xata don't create table", async () => {
        ...
        expect(t).toThrowError("If createTable is set, an apiKey must be provided to XataChatMessageHistoryInput, either directly or through the config object");
        const t1 = () => {
            // eslint-disable-next-line no-new
            new XataChatMessageHistory({
                sessionId: randomSessionId(),
