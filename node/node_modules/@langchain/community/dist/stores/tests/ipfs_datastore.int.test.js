...
describe.skip("IPFSDatastoreChatMessageHistory", () => {
    ...
    test("IPFSDatastoreChatMessageHistory: add and get messages", async () => {
        ...
        await messageHistory.addAIChatMessage("Yes you seem to be. I am a nice AI.");
        ...
        expect(await messageHistorySameSession.getMessages()).toEqual(expectedMessages);
    });
    test("IPFSDatastoreChatMessageHistory: clear messages", async () => {
        ...
        expect(await messageHistoryToClear.getMessages()).toEqual(expectedMessagesToClear);
